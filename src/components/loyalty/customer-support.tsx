...
export function CustomerSupport() {
  return (
    <aside className="mx-auto w-full max-w-5xl px-4 pb-0 sm:px-6" aria-label="Bantuan dan order Kira Kira Michi">
      <div className="flex flex-col items-center gap-3 rounded-2xl border border-line bg-white p-4 text-center sm:flex-row sm:justify-between sm:gap-4 sm:p-5 sm:text-left">
        ...
        <div className="flex w-full flex-col items-stretch justify-center gap-2 sm:w-auto md:flex-row md:flex-wrap md:justify-end">
