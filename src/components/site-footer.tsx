...
export function SiteFooter() {
  return (
    <footer className="mt-2 border-t border-line bg-white px-4 pb-[calc(6.5rem+env(safe-area-inset-bottom))] pt-3 text-xs text-ink-muted sm:mt-3 lg:pb-7 lg:pt-4">
